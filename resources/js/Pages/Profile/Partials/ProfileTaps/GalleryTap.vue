  ...
  <Card class="mt-3">
    <section class="py-6">
      ...
      <div class="text-center">
        ...
        <p class="text-gray-500 mt-2">Explore this user’s stunning media collection!</p>
      </div>
      ...
      <div class="mt-8">
        ...
        <p v-else class="text-center text-gray-500 mt-4">
          This user does not have any media.
        </p>
      </div>
    </section>
...
import GalleryCard from "./Partials/GalleryCard.vue";
