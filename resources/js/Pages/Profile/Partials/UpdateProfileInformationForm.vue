      ...
      <div>
        <div class="flex items-center gap-4">
          ...
          >
            ...
            <img
              class="w-full h-full object-cover group-hover:opacity-80 duration-150"
      ...
      <div>
        <div class="flex items-center gap-4">
          ...
          >
            ...
            <img
              class="w-full h-full object-cover group-hover:opacity-80 duration-150"
              :src="image.preview_cover_image ?? user.cover"
              alt=""
              onerror="https://addcovers.com/covers/anubgendls898ni.jpg"
            />
          </label>
        </div>
...
const submit = () => {
  form.post(route("profile.update", user.value.username), {
    preserveScroll: true,
    forceFormData: true,
    onSuccess: () => {
